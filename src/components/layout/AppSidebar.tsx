...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/integrations/naver",  label: "네이버예약 연동 준비", icon: Link2, badge: "준비중" },
  { href: "/messages",            label: "문자·알림톡·노쇼",    icon: MessageSquare },
  { href: "/security",            label: "보안 및 권한 관리",    icon: Shield },
  { href: "/settings",            label: "설정",                 icon: Settings },
  { href: "/qa",                  label: "QA 검수센터",          icon: FlaskConical, ownerOnly: true },
];
      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 overflow-y-auto">
          <ul className="space-y-0.5">
            {NAV_ITEMS
              .filter((item) => !item.ownerOnly || userData?.role === "owner")
